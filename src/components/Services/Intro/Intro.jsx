    ...
    return (
        <div className={classes.Intro}>
            ...
            <div className={classes.Text}>
                ...
                <p>Home Inspectors on provide their customers assurance with the safety and functions of their home. Our inspectors follow the InterNACHI Standards of Practice, which is the world's leading association for home inspectors. Our Certified Professional Inspectors (CPI) strive to keep up with new, emerging technologies to accomplish quality work on every home. Whether you are looking to do a 4-Point, Wind Mitigation, or a Home Inspection, we got you covered!</p>
