    ...
    return (
        <div className={classes.Intro}>
            ...
            <div className={classes.Text}>
                ...
                <p>Home Inspectors provide their customers assurance with the safety and functions of their home. Our inspectors follow the <a target="_blank" rel="noopener noreferrer" href="https://s3.amazonaws.com/uploads-east-1.nachi.org/page-uploads%2F2020%2F03%2F1584478818326-Home+Inspection+Standards+of+Practice.pdf">InterNACHI Standards of Practice</a>, which is the world's leading association for home inspectors. Our Certified Professional Inspectors (CPI) strive to keep up with new, emerging technologies to accomplish quality work on every home. Whether you are looking to do a 4-Point, Wind Mitigation, or a Home Inspection, we've got you covered!</p>
