    ...
    return (
        <div className={classes.Services}>
            ...
            <div className={classes.ServiceGroup}>
                <Service title="Home Inspection" icon="fas fa-house-damage" startingAt="Starting at: " price="275" description="A Home Inspection is a non-invasive examination of the condition of the home. Our Home Inspection consists of inspecting the most important components of a home, such as the foundation, frame, and roof, among others. Home Inspections typically take between 2 to 3 1/2 hours." />
